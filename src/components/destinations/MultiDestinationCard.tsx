...
type MultiDestinationCardProps = {
  name: string;
...
export const MultiDestinationCard = ({
  destinations,
  link,
  buttonText,
  stats,
        ...
        {destinations.map((dest, idx) => (
          <div key={dest.name} className="relative aspect-video">
            ...
            <div className="absolute bottom-4 left-4 z-20">
              <span className="px-4 py-2 bg-black/40 backdrop-blur-md rounded-lg text-white text-sm sm:text-base font-medium shadow-lg">
                {dest.name}
              </span>
            </div>
          </div>
        ...
        {destinations.map((dest, idx) => (
          <div key={dest.name} className="mb-6">
            <div className="relative aspect-video mb-4">
              ...
              />
              <div className="absolute bottom-4 left-4 z-20">
                <span className="px-4 py-2 bg-black/40 backdrop-blur-md rounded-lg text-white text-sm font-medium shadow-lg">
                  {dest.name}
                </span>
              </div>
            </div>

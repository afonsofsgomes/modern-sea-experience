...
export const NavbarMobileMenu: React.FC<NavbarMobileMenuProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white flex flex-col md:hidden animate-fade-in overscroll-none">
      <div className="absolute top-0 left-0 right-0 h-16 bg-white flex items-center justify-end px-4">
        <button 
          onClick={onClose}
